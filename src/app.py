...
from config import CAMINHO_DB, ICONE_MODELO, ICONE_USUARIO, FAVICON
...
if pergunta := st.chat_input("Faça sua pergunta ao Gemma"):
    ...
    with st.chat_message("assistant", avatar=ICONE_MODELO):
        ...
        with st.spinner("Gerando resposta..."):
            try:
                ...
                # Extração das fontes vindas do LlamaIndex
                fontes_extraidas = []
