...
Este Estudo de Caso tem como objetivo o desenvolvimento de um sistema de RAG (Retrieval-Augmented Generation) Híbrido, capaz de consultar e utilizar informações extraídas de documentos PDF para responder perguntas em linguagem natural.
